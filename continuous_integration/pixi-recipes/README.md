...
because it is a dependency of conda package dask-core (defined in pixi.toml), and conda
packages can't depend on pip packages.
...
As of 1.2.0, brotli3 does not release the GIL on import in Python 3.14t.
